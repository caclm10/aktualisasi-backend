...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
         ...
         * @static
         */
        public static function nanoid($column = 'id', $length = 21)
        {
            return \Illuminate\Database\Schema\Blueprint::nanoid($column, $length);
        }
         ...
         * @static
         */
        public static function foreignNanoid($column, $length = 21)
        {
            return \Illuminate\Database\Schema\Blueprint::foreignNanoid($column, $length);
        }
